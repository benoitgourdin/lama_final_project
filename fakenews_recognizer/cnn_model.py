...
from tensorflow.python.keras import Input, Sequential, regularizers
from tensorflow.python.keras.layers import Conv1D, MaxPooling1D, Flatten, Dense, Embedding, GlobalMaxPooling1D
import numpy as np
